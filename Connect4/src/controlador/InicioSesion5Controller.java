 ...
 */
public class InicioSesion5Controller implements Initializable {
    ...
    private void bJugar(ActionEvent event) {
        ...
        if(noPuedefxID.getText().equals("Sesion Iniciada")){
            ...
            java.util.logging.Logger.getLogger(InicioSesion5Controller.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void bIniSesion(ActionEvent event) {
        ...
        String x = JugarPlayerController.a;
