 ...
 */
public class InicioSesion3Controller implements Initializable {
    ...
    private void bJugar(ActionEvent event) {
        ...
        if(noPuedefxID.getText().equals("Sesion Iniciada")){
            ...
            java.util.logging.Logger.getLogger(InicioSesion3Controller.class.getName()).log(Level.SEVERE, null, ex);
        }
